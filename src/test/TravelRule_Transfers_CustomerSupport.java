...
public class TravelRule_Transfers_CustomerSupport extends Utility {
...
//==================================>> Sender Address Fields <<=====================================================================
	...
	public void tc001TravelRule_POBox_Validation_For_SenderAddress_FW_Transfers() throws Exception {
		AddSenderDetails objSenderDtls = TestDataReader.loadSenderDetails("TRVL-RTD-TRNS-001");
...
// Now Clicking the Sender Address check Box		
	...
	public void tc002TravelRule_WhitelistedCountry_Validation_For_SenderAddress_FW_Transfers() throws Exception {
		AddSenderDetails objSenderDtls = TestDataReader.loadSenderDetails("TRVL-RTD-TRNS-002");
		AddRecipientDetails objReciDtls = TestDataReader.loadRecipientDetails("TRVL-000");
		AddSenderDetails.selectCustomerSupport();
		AddSenderDetails.Clik_Transfers_Link_DepOp();
		AddSenderDetails.select_ClinetsRoutingNum(objSenderDtls);
...
//  Now Clicking the Sender Address check Box				
	...
	public void tc003TravelRule_BlacklistedCountry_Validation_For_SenderAddress_FW_Transfers() throws Exception {
		AddSenderDetails objSenderDtls = TestDataReader.loadSenderDetails("TRVL-RTD-TRNS-003");
		AddRecipientDetails objReciDtls = TestDataReader.loadRecipientDetails("TRVL-000");
		AddSenderDetails.selectCustomerSupport();
		AddSenderDetails.Clik_Transfers_Link_DepOp();
		AddSenderDetails.select_ClinetsRoutingNum(objSenderDtls);
...
//  Now Clicking the Sender Address check Box						
	...
	public void tc004TravelRule_POBox_And_WhitelistedCountry_Validation_For_SenderAddress_FW_Transfers() throws Exception {
		AddSenderDetails objSenderDtls = TestDataReader.loadSenderDetails("TRVL-RTD-TRNS-004");
		AddRecipientDetails objReciDtls = TestDataReader.loadRecipientDetails("TRVL-000");
		AddSenderDetails.selectCustomerSupport();
		AddSenderDetails.Clik_Transfers_Link_DepOp();
		AddSenderDetails.select_ClinetsRoutingNum(objSenderDtls);
...
//  Now Clicking the Sender Address check Box						
	...
	public void tc005TravelRule_POBox_And_BlacklistedCountry_Validation_For_SenderAddress_FW_Transfers() throws Exception {
		AddSenderDetails objSenderDtls = TestDataReader.loadSenderDetails("TRVL-RTD-TRNS-005");
		AddRecipientDetails objReciDtls = TestDataReader.loadRecipientDetails("TRVL-000");
		AddSenderDetails.selectCustomerSupport();
		AddSenderDetails.Clik_Transfers_Link_DepOp();
		AddSenderDetails.select_ClinetsRoutingNum(objSenderDtls);
...
//  Now Clicking the Sender Address check Box						
	...
	public void tc006TravelRule_POBox_And_InvalidToValid_For_SenderAddress_FW_Transfers() throws Exception {
		AddSenderDetails objSenderDtls = TestDataReader.loadSenderDetails("TRVL-RTD-TRNS-001");
		AddRecipientDetails objReciDtls = TestDataReader.loadRecipientDetails("TRVL-000");
		AddSenderDetails.selectCustomerSupport();
		AddSenderDetails.Clik_Transfers_Link_DepOp();
...
// Now entering the Valid Sender Address 		
		AddSenderDetails objSenderDtls2 = TestDataReader.loadSenderDetails("TRVL-RTD-TRNS-000");
	...
	public void tc007TravelRule_Whitelisted_And_InvalidToValid_For_SenderAddress_FW_Transfers() throws Exception {
		AddSenderDetails objSenderDtls = TestDataReader.loadSenderDetails("TRVL-RTD-TRNS-002");
		AddRecipientDetails objReciDtls = TestDataReader.loadRecipientDetails("TRVL-000");
		AddSenderDetails.selectCustomerSupport();
		AddSenderDetails.Clik_Transfers_Link_DepOp();
...
// Now entering the Valid Sender Address 		
	...
	public void tc008TravelRule_Blacklisted_And_InvalidToValid_For_SenderAddress_FW_Transfers() throws Exception {
		AddSenderDetails objSenderDtls = TestDataReader.loadSenderDetails("TRVL-RTD-TRNS-003");
		AddRecipientDetails objReciDtls = TestDataReader.loadRecipientDetails("TRVL-000");
		AddSenderDetails.selectCustomerSupport();
		AddSenderDetails.Clik_Transfers_Link_DepOp();
...
// Now entering the Valid Sender Address 		
	...
	public void tc009TravelRule_POBox_Whitelisted_And_InvalidToValid_For_SenderAddress_FW_Transfers() throws Exception {
		AddSenderDetails objSenderDtls = TestDataReader.loadSenderDetails("TRVL-RTD-TRNS-004");
		AddRecipientDetails objReciDtls = TestDataReader.loadRecipientDetails("TRVL-000");
		AddSenderDetails.selectCustomerSupport();
		AddSenderDetails.Clik_Transfers_Link_DepOp();
...
// Now entering the Valid Sender Address 		
	...
	public void tc010TravelRule_POBox_Blacklisted_And_InvalidToValid_For_SenderAddress_FW_Transfers() throws Exception {
		AddSenderDetails objSenderDtls = TestDataReader.loadSenderDetails("TRVL-RTD-TRNS-005");
		AddRecipientDetails objReciDtls = TestDataReader.loadRecipientDetails("TRVL-000");
		AddSenderDetails.selectCustomerSupport();
		AddSenderDetails.Clik_Transfers_Link_DepOp();
...
// Now entering the Valid Sender Address 		
	...
	public void tc011TravelRule_POBox_And_ValidToInValid_For_SenderAddress_FW_Transfers() throws Exception {
		AddSenderDetails objSenderDtls = TestDataReader.loadSenderDetails("TRVL-RTD-TRNS-000");
		AddRecipientDetails objReciDtls = TestDataReader.loadRecipientDetails("TRVL-000");
		AddSenderDetails.selectCustomerSupport();
		AddSenderDetails.Clik_Transfers_Link_DepOp();
		AddSenderDetails.select_ClinetsRoutingNum(objSenderDtls);
...
//  Enter Invalid Address --> Address with P.O.Box 	
		AddSenderDetails objSenderDtls2 = TestDataReader.loadSenderDetails("TRVL-RTD-TRNS-001");
		AddSenderDetails.enterSenderAddressDetailsInAllIndividualFields(objSenderDtls2);
// Error Message Validation --> P.O.Box 
		AddRecipientDetails.continueBtnClick_With_No_travelRuleMethod();
		ErrorMessageData objErrDtls = TestDataReader.loadErrorMsg();
...
// Clicking the Sender Address Check Box		
	...
	public void tc012TravelRule_WhiteListed_And_ValidToInValid_For_SenderAddress_FW_Transfers() throws Exception {
		AddSenderDetails objSenderDtls = TestDataReader.loadSenderDetails("TRVL-RTD-TRNS-000");
		AddRecipientDetails objReciDtls = TestDataReader.loadRecipientDetails("TRVL-000");
		AddSenderDetails.selectCustomerSupport();
		AddSenderDetails.Clik_Transfers_Link_DepOp();
...
//	Enter Invalid Address --> Address with WhiteListed_Country
		AddSenderDetails objSenderDtls2 = TestDataReader.loadSenderDetails("TRVL-RTD-TRNS-002");
		AddSenderDetails.enterSenderAddressDetailsInAllIndividualFields(objSenderDtls2);
// Error Message Validation --> Whitelisted_Country
		AddRecipientDetails.continueBtnClick_With_No_travelRuleMethod();
		ErrorMessageData objErrDtls = TestDataReader.loadErrorMsg();
...
// Clicking the Sender Address Check Box				
	...
	public void tc013TravelRule_BlackListed_And_ValidToInValid_For_SenderAddress_FW_Transfers() throws Exception {
		AddSenderDetails objSenderDtls = TestDataReader.loadSenderDetails("TRVL-RTD-TRNS-000");
		AddRecipientDetails objReciDtls = TestDataReader.loadRecipientDetails("TRVL-000");
		AddSenderDetails.selectCustomerSupport();
		AddSenderDetails.Clik_Transfers_Link_DepOp();
...
//	Enter Invalid Address --> Address with BlackListed_Country
		AddSenderDetails objSenderDtls2 = TestDataReader.loadSenderDetails("TRVL-RTD-TRNS-003");
		AddSenderDetails.enterSenderAddressDetailsInAllIndividualFields(objSenderDtls2);
// Error Message Validation --> Blacklisted_Country
		AddRecipientDetails.continueBtnClick_With_No_travelRuleMethod();
		ErrorMessageData objErrDtls = TestDataReader.loadErrorMsg();
...
// Clicking the Sender Address Check Box				
	...
	public void tc014TravelRule_POBox_And_WhiteListedCountry_ValidToInValid_For_SenderAddress_FW_Transfers() throws Exception {
		AddSenderDetails objSenderDtls = TestDataReader.loadSenderDetails("TRVL-RTD-TRNS-000");
		AddRecipientDetails objReciDtls = TestDataReader.loadRecipientDetails("TRVL-000");
		AddSenderDetails.selectCustomerSupport();
		AddSenderDetails.Clik_Transfers_Link_DepOp();
...
//	Enter Invalid Address --> Address with P.O.Box & WhiteListed_Country
		AddSenderDetails objSenderDtls2 = TestDataReader.loadSenderDetails("TRVL-RTD-TRNS-004");
		AddSenderDetails.enterSenderAddressDetailsInAllIndividualFields(objSenderDtls2);
// Error Message Validation --> P.O.Box & Whitelisted_Country
		AddRecipientDetails.continueBtnClick_With_No_travelRuleMethod();
		ErrorMessageData objErrDtls = TestDataReader.loadErrorMsg();
...
// Clicking the Sender Address Check Box		
	...
	public void tc015TravelRule_POBox_And_BlackListedCountry_ValidToInValid_For_SenderAddress_FW_Transfers() throws Exception {
		AddSenderDetails objSenderDtls = TestDataReader.loadSenderDetails("TRVL-RTD-TRNS-000");
		AddRecipientDetails objReciDtls = TestDataReader.loadRecipientDetails("TRVL-000");
		AddSenderDetails.selectCustomerSupport();
		AddSenderDetails.Clik_Transfers_Link_DepOp();
...
//	Enter Invalid Address --> Address with P.O.Box & BlackListed_Country
		AddSenderDetails objSenderDtls2 = TestDataReader.loadSenderDetails("TRVL-RTD-TRNS-005");
		AddSenderDetails.enterSenderAddressDetailsInAllIndividualFields(objSenderDtls2);
// Error Message Validation --> P.O.Box & Blacklisted_Country
		AddRecipientDetails.continueBtnClick_With_No_travelRuleMethod();
		ErrorMessageData objErrDtls = TestDataReader.loadErrorMsg();
...
//=======================>> Recipient Address Fields <<=====================================================================	
	...
	@Test(testName = "TravelRule_POBox_Validation_For_RecipientAddress", priority = 16)
			public void tc016TravelRule_POBox_Validation_For_RecipientAddress_FW_Transfers() throws Exception {
				AddSenderDetails objSenderDtls = TestDataReader.loadSenderDetails("TRVL-RTD-TRNS-000");
...
// Now Clicking the Recipient Address check Box		
			...
			public void tc017TravelRule_WhitelistedCountry_Validation_For_RecipientAddress_FW_Transfers() throws Exception {
				AddSenderDetails objSenderDtls = TestDataReader.loadSenderDetails("TRVL-RTD-TRNS-000");
...
//  Now Clicking the Recipient Address check Box				
			...
			public void tc018TravelRule_BlacklistedCountry_Validation_For_RecipientAddress_FW_Transfers() throws Exception {
				AddSenderDetails objSenderDtls = TestDataReader.loadSenderDetails("TRVL-RTD-TRNS-000");
...
//  Now Clicking the Recipient Address check Box						
			...
			public void tc019TravelRule_POBox_And_WhitelistedCountry_Validation_For_RecipientAddress_FW_Transfers() throws Exception {
				AddSenderDetails objSenderDtls = TestDataReader.loadSenderDetails("TRVL-RTD-TRNS-000");
...
//  Now Clicking the Recipient Address check Box						
			...
			public void tc020TravelRule_POBox_And_BlacklistedCountry_Validation_For_RecipientAddress_FW_Transfers() throws Exception {
				AddSenderDetails objSenderDtls = TestDataReader.loadSenderDetails("TRVL-RTD-TRNS-000");
...
//  Now Clicking the Recipient Address check Box						
			...
			public void tc021TravelRule_POBox_And_InvalidToValid_For_RecipientAddress_FW_Transfers() throws Exception {
				AddSenderDetails objSenderDtls = TestDataReader.loadSenderDetails("TRVL-RTD-TRNS-000");
				AddRecipientDetails objReciDtls = TestDataReader.loadRecipientDetails("TRVL-001");
				AddSenderDetails.selectCustomerSupport();
				AddSenderDetails.Clik_Transfers_Link_DepOp();
...
// Now entering the Valid Recipient Address 		
			...
			public void tc022TravelRule_Whitelisted_And_InvalidToValid_For_RecipientAddress_FW_Transfers() throws Exception {
				AddSenderDetails objSenderDtls = TestDataReader.loadSenderDetails("TRVL-RTD-TRNS-000");
				AddRecipientDetails objReciDtls = TestDataReader.loadRecipientDetails("TRVL-002");
				AddSenderDetails.selectCustomerSupport();
				AddSenderDetails.Clik_Transfers_Link_DepOp();
...
// Now entering the Valid Recipient Address 		
			...
			public void tc023TravelRule_Blacklisted_And_InvalidToValid_For_RecipientAddress_FW_Transfers() throws Exception {
				AddSenderDetails objSenderDtls = TestDataReader.loadSenderDetails("TRVL-RTD-TRNS-000");
				AddRecipientDetails objReciDtls = TestDataReader.loadRecipientDetails("TRVL-003");
				AddSenderDetails.selectCustomerSupport();
				AddSenderDetails.Clik_Transfers_Link_DepOp();
...
// Now entering the Valid Recipient Address 		
			...
			public void tc024TravelRule_POBox_Whitelisted_And_InvalidToValid_For_RecipientAddress_FW_Transfers() throws Exception {
				AddSenderDetails objSenderDtls = TestDataReader.loadSenderDetails("TRVL-RTD-TRNS-000");
				AddRecipientDetails objReciDtls = TestDataReader.loadRecipientDetails("TRVL-004");
				AddSenderDetails.selectCustomerSupport();
				AddSenderDetails.Clik_Transfers_Link_DepOp();
...
// Now entering the Valid Recipient Address 		
			...
			public void tc025TravelRule_POBox_Blacklisted_And_InvalidToValid_For_RecipientAddress_FW_Transfers() throws Exception {
				AddSenderDetails objSenderDtls = TestDataReader.loadSenderDetails("TRVL-RTD-TRNS-000");
				AddRecipientDetails objReciDtls = TestDataReader.loadRecipientDetails("TRVL-005");
				AddSenderDetails.selectCustomerSupport();
				AddSenderDetails.Clik_Transfers_Link_DepOp();
...
// Now entering the Valid Recipient Address 		
			...
			public void tc026TravelRule_POBox_And_ValidToInValid_For_RecipientAddress_FW_Transfers() throws Exception {
				AddSenderDetails objSenderDtls = TestDataReader.loadSenderDetails("TRVL-RTD-TRNS-000");
				AddRecipientDetails objReciDtls = TestDataReader.loadRecipientDetails("TRVL-000");
				AddSenderDetails.selectCustomerSupport();
				AddSenderDetails.Clik_Transfers_Link_DepOp();
...
// Clicking the Sender Address Check Box		
			...
			public void tc027TravelRule_WhiteListed_And_ValidToInValid_For_RecipientAddress_FW_Transfers() throws Exception {
				AddSenderDetails objSenderDtls = TestDataReader.loadSenderDetails("TRVL-RTD-TRNS-000");
				AddRecipientDetails objReciDtls = TestDataReader.loadRecipientDetails("TRVL-000");
				AddSenderDetails.selectCustomerSupport();
				AddSenderDetails.Clik_Transfers_Link_DepOp();
...
// Clicking the Recipient Address Check Box				
			...
			public void tc028TravelRule_BlackListed_And_ValidToInValid_For_RecipientAddress_FW_Transfers() throws Exception {
				AddSenderDetails objSenderDtls = TestDataReader.loadSenderDetails("TRVL-RTD-TRNS-000");
				AddRecipientDetails objReciDtls = TestDataReader.loadRecipientDetails("TRVL-000");
				AddSenderDetails.selectCustomerSupport();
				AddSenderDetails.Clik_Transfers_Link_DepOp();
...
// Clicking the Recipient Address Check Box				
			...
			public void tc029TravelRule_POBox_And_WhiteListedCountry_ValidToInValid_For_RecipientAddress_FW_Transfers() throws Exception {
				AddSenderDetails objSenderDtls = TestDataReader.loadSenderDetails("TRVL-RTD-TRNS-000");
				AddRecipientDetails objReciDtls = TestDataReader.loadRecipientDetails("TRVL-000");
				AddSenderDetails.selectCustomerSupport();
				AddSenderDetails.Clik_Transfers_Link_DepOp();
...
// Clicking the Recipient Address Check Box		
			...
			public void tc030TravelRule_POBox_And_BlackListedCountry_ValidToInValid_For_RecipientAddress_FW_Transfers() throws Exception {
				AddSenderDetails objSenderDtls = TestDataReader.loadSenderDetails("TRVL-RTD-TRNS-000");
				AddRecipientDetails objReciDtls = TestDataReader.loadRecipientDetails("TRVL-000");
				AddSenderDetails.selectCustomerSupport();
				AddSenderDetails.Clik_Transfers_Link_DepOp();
