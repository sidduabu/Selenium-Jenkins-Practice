...
public class Validation_DepOp_AddRecipient_FedWire extends Utility {
	...
	public void startSuite() throws Exception {
		...
		AddSenderDetails objSenderDtls = TestDataReader.loadSenderDetails("VD-RC-RTD-FW-000");
	...
	public static void tc01_EmptyDivision_VD_AddRecip_CustSupport_FedWire() throws Exception {
		AddSenderDetails objSenderDtls = TestDataReader.loadSenderDetails("VD-RC-RTD-FW-001");
	...
	public static void tc02EmptyTransferType_VD_AddRecip_CustSupport_FedWire() throws Exception {
		AddSenderDetails objSenderDtls = TestDataReader.loadSenderDetails("VD-RC-RTD-FW-002");
		AddSenderDetails.addRecipBtnClick_SelectDivision_TransferType_PmtNetwk(objSenderDtls);
		AddSenderDetails.enterSenderAccountNumber_DepOp004(objSenderDtls);
		ErrorMessageData objErrDtls = TestDataReader.loadErrorMsg();
	...
	public static void tc03EmptyPaymentMethod_VD_AddRecip_CustSupport_FedWire() throws Exception {
		AddSenderDetails objSenderDtls = TestDataReader.loadSenderDetails("VD-RC-RTD-FW-003");
		AddSenderDetails.addRecipBtnClick_SelectDivision_TransferType_PmtNetwk(objSenderDtls);
		AddSenderDetails.enterSenderAccountNumber_DepOp004(objSenderDtls);
		AddRecipientDetails objReciDtls = TestDataReader.loadRecipientDetails_02("VD-RC-RTD-FW-000");
	...
	public static void tc04EmptyRecipientType_VD_AddRecip_CustSupport_FedWire() throws Exception {
		AddSenderDetails objSenderDtls = TestDataReader.loadSenderDetails("VD-RC-RTD-FW-004");
		AddSenderDetails.addRecipBtnClick_SelectDivision_TransferType_PmtNetwk(objSenderDtls);
		AddSenderDetails.enterSenderAccountNumber_DepOp004(objSenderDtls);
		ErrorMessageData objErrDtls = TestDataReader.loadErrorMsg();
	...
	public static void tc05InvalidNickname_VD_AddRecip_CustSupport_FedWire() throws Exception {
		AddSenderDetails objSenderDtls = TestDataReader.loadSenderDetails("VD-RC-RTD-FW-000");
		AddRecipientDetails objReciDtls = TestDataReader.loadRecipientDetails_02("VD-RC-RTD-FW-005");
		AddSenderDetails.addRecipBtnClick_SelectDivision_TransferType_PmtNetwk(objSenderDtls);
		AddSenderDetails.enterSenderAccountNumber_DepOp004(objSenderDtls); 
	...
	public static void tc06EmptyRecipientName_VD_AddRecip_CustSupport_FedWire() throws Exception {
		AddSenderDetails objSenderDtls = TestDataReader.loadSenderDetails("VD-RC-RTD-FW-000");
		AddRecipientDetails objReciDtls = TestDataReader.loadRecipientDetails_02("VD-RC-RTD-FW-006");
		AddSenderDetails.addRecipBtnClick_SelectDivision_TransferType_PmtNetwk(objSenderDtls);
		AddSenderDetails.enterSenderAccountNumber_DepOp004(objSenderDtls); 
		AddRecipientDetails.recipDetails2(objReciDtls);
		AddRecipientDetails.recipBankDetails(objReciDtls);
	...
	public static void tc07InvalidRecipientName_VD_AddRecip_CustSupport_FedWire() throws Exception {
		AddSenderDetails objSenderDtls = TestDataReader.loadSenderDetails("VD-RC-RTD-FW-000");
		AddRecipientDetails objReciDtls = TestDataReader.loadRecipientDetails_02("VD-RC-RTD-FW-007");
		AddSenderDetails.addRecipBtnClick_SelectDivision_TransferType_PmtNetwk(objSenderDtls);
		AddSenderDetails.enterSenderAccountNumber_DepOp004(objSenderDtls); 
		AddRecipientDetails.recipDetails2(objReciDtls);
		AddRecipientDetails.recipBankDetails(objReciDtls);
	...
	public static void tc08EmptyAddressLine_VD_AddRecip_CustSupport_FedWire() throws Exception {
		AddSenderDetails objSenderDtls = TestDataReader.loadSenderDetails("VD-RC-RTD-FW-000");
		AddRecipientDetails objReciDtls = TestDataReader.loadRecipientDetails_02("VD-RC-RTD-FW-008");
		AddSenderDetails.addRecipBtnClick_SelectDivision_TransferType_PmtNetwk(objSenderDtls);
		AddSenderDetails.enterSenderAccountNumber_DepOp004(objSenderDtls); 
		AddRecipientDetails.recipDetails2(objReciDtls);
		AddRecipientDetails.recipBankDetails(objReciDtls);
	...
	public static void tc09InvalidAddressLine_VD_AddRecip_CustSupport_FedWire() throws Exception {
		AddSenderDetails objSenderDtls = TestDataReader.loadSenderDetails("VD-RC-RTD-FW-000");
		AddRecipientDetails objReciDtls = TestDataReader.loadRecipientDetails_02("VD-RC-RTD-FW-009");
		AddSenderDetails.addRecipBtnClick_SelectDivision_TransferType_PmtNetwk(objSenderDtls);
		AddSenderDetails.enterSenderAccountNumber_DepOp004(objSenderDtls); 
		AddRecipientDetails.recipDetails2(objReciDtls);
		AddRecipientDetails.recipBankDetails(objReciDtls);
		AddRecipientDetails.enterRecipientAddressDetailsInAllIndividualFields(objReciDtls);
		ErrorMessageData objErrDtls = TestDataReader.loadErrorMsg();
		ValidationPage.continueClick_And_AssertingSingleErrorFieldMsg(objErrDtls.getInvalidAddressLine());
	}

	@Test(priority = 10, testName = "EmptyTownName")
	public static void tc010EmptyTownName_VD_AddRecip_CustSupport_FedWire() throws Exception {
		AddSenderDetails objSenderDtls = TestDataReader.loadSenderDetails("VD-RC-RTD-FW-000");
		AddRecipientDetails objReciDtls = TestDataReader.loadRecipientDetails_02("VD-RC-RTD-FW-010");
		AddSenderDetails.addRecipBtnClick_SelectDivision_TransferType_PmtNetwk(objSenderDtls);
		AddSenderDetails.enterSenderAccountNumber_DepOp004(objSenderDtls); 
		AddRecipientDetails.recipDetails2(objReciDtls);
		AddRecipientDetails.recipBankDetails(objReciDtls);
	...
	public static void tc011InvalidTownName_VD_AddRecip_CustSupport_FedWire() throws Exception {
		AddSenderDetails objSenderDtls = TestDataReader.loadSenderDetails("VD-RC-RTD-FW-000");
		AddRecipientDetails objReciDtls = TestDataReader.loadRecipientDetails_02("VD-RC-RTD-FW-011");
		AddSenderDetails.addRecipBtnClick_SelectDivision_TransferType_PmtNetwk(objSenderDtls);
		AddSenderDetails.enterSenderAccountNumber_DepOp004(objSenderDtls); 
		AddRecipientDetails.recipDetails2(objReciDtls);
		AddRecipientDetails.recipBankDetails(objReciDtls);
		AddRecipientDetails.enterRecipientAddressDetailsInAllIndividualFields(objReciDtls);
		ErrorMessageData objErrDtls = TestDataReader.loadErrorMsg();
		ValidationPage.continueClick_And_AssertingSingleErrorFieldMsg(objErrDtls.getInvdRecipTown());
	}

	@Test(priority = 12, testName = "EmptyState")
	public static void tc012EmptyState_VD_AddRecip_CustSupport_FedWire() throws Exception {
		AddSenderDetails objSenderDtls = TestDataReader.loadSenderDetails("VD-RC-RTD-FW-000");
		AddRecipientDetails objReciDtls = TestDataReader.loadRecipientDetails_02("VD-RC-RTD-FW-012");
		AddSenderDetails.addRecipBtnClick_SelectDivision_TransferType_PmtNetwk(objSenderDtls);
		AddSenderDetails.enterSenderAccountNumber_DepOp004(objSenderDtls); 
		AddRecipientDetails.recipDetails2(objReciDtls);
		AddRecipientDetails.recipBankDetails(objReciDtls);
	...
	public static void tc013EmptyCountry_VD_AddRecip_CustSupport_FedWire() throws Exception {
		AddSenderDetails objSenderDtls = TestDataReader.loadSenderDetails("VD-RC-RTD-FW-000");
		AddRecipientDetails objReciDtls = TestDataReader.loadRecipientDetails_02("VD-RC-RTD-FW-013");
		AddSenderDetails.addRecipBtnClick_SelectDivision_TransferType_PmtNetwk(objSenderDtls);
		AddSenderDetails.enterSenderAccountNumber_DepOp004(objSenderDtls); 
		AddRecipientDetails.recipDetails2(objReciDtls);
		AddRecipientDetails.recipBankDetails(objReciDtls);
	...
	public static void tc014EmptyZip_VD_AddRecip_CustSupport_FedWire() throws Exception {
		AddSenderDetails objSenderDtls = TestDataReader.loadSenderDetails("VD-RC-RTD-FW-000");
		AddRecipientDetails objReciDtls = TestDataReader.loadRecipientDetails_02("VD-RC-RTD-FW-014");
		AddSenderDetails.addRecipBtnClick_SelectDivision_TransferType_PmtNetwk(objSenderDtls);
		AddSenderDetails.enterSenderAccountNumber_DepOp004(objSenderDtls); 
		AddRecipientDetails.recipDetails2(objReciDtls);
		AddRecipientDetails.recipBankDetails(objReciDtls);
	...
	public static void tc015InvalidZip_VD_AddRecip_CustSupport_FedWire() throws Exception {
		AddSenderDetails objSenderDtls = TestDataReader.loadSenderDetails("VD-RC-RTD-FW-000");
		AddRecipientDetails objReciDtls = TestDataReader.loadRecipientDetails_02("VD-RC-RTD-FW-015");
		AddSenderDetails.addRecipBtnClick_SelectDivision_TransferType_PmtNetwk(objSenderDtls);
		AddSenderDetails.enterSenderAccountNumber_DepOp004(objSenderDtls); 
		AddRecipientDetails.recipDetails2(objReciDtls);
		AddRecipientDetails.recipBankDetails(objReciDtls);
	...
	public static void tc016InvalidEmail_VD_AddRecip_CustSupport_FedWire() throws Exception {
		AddSenderDetails objSenderDtls = TestDataReader.loadSenderDetails("VD-RC-RTD-FW-000");
		AddRecipientDetails objReciDtls = TestDataReader.loadRecipientDetails_02("VD-RC-RTD-FW-016");
		AddSenderDetails.addRecipBtnClick_SelectDivision_TransferType_PmtNetwk(objSenderDtls);
		AddSenderDetails.enterSenderAccountNumber_DepOp004(objSenderDtls); 
		AddRecipientDetails.recipDetails2(objReciDtls);
		AddRecipientDetails.recipBankDetails(objReciDtls);
	...
	public static void tc017InvalidPhone_VD_AddRecip_CustSupport_FedWire() throws Exception {
		AddSenderDetails objSenderDtls = TestDataReader.loadSenderDetails("VD-RC-RTD-FW-000");
		AddRecipientDetails objReciDtls = TestDataReader.loadRecipientDetails_02("VD-RC-RTD-FW-017");
		AddSenderDetails.addRecipBtnClick_SelectDivision_TransferType_PmtNetwk(objSenderDtls);
		AddSenderDetails.enterSenderAccountNumber_DepOp004(objSenderDtls); 
		AddRecipientDetails.recipDetails2(objReciDtls);
		AddRecipientDetails.recipBankDetails(objReciDtls);
	...
	public static void tc018EmptyRoutingNum_VD_AddRecip_CustSupport_FedWire() throws Exception {
		AddSenderDetails objSenderDtls = TestDataReader.loadSenderDetails("VD-RC-RTD-FW-000");
		AddRecipientDetails objReciDtls = TestDataReader.loadRecipientDetails_02("VD-RC-RTD-FW-018");
		AddSenderDetails.addRecipBtnClick_SelectDivision_TransferType_PmtNetwk(objSenderDtls);
		AddSenderDetails.enterSenderAccountNumber_DepOp004(objSenderDtls); 
		AddRecipientDetails.recipDetails2(objReciDtls);
		AddRecipientDetails.recipBankDetails(objReciDtls);
	...
	public static void tc019InvalidRoutingNum_VD_AddRecip_CustSupport_FedWire() throws Exception {
		AddSenderDetails objSenderDtls = TestDataReader.loadSenderDetails("VD-RC-RTD-FW-000");
		AddRecipientDetails objReciDtls = TestDataReader.loadRecipientDetails_02("VD-RC-RTD-FW-019");
		AddSenderDetails.addRecipBtnClick_SelectDivision_TransferType_PmtNetwk(objSenderDtls);
		AddSenderDetails.enterSenderAccountNumber_DepOp004(objSenderDtls); 
		AddRecipientDetails.recipDetails2(objReciDtls);
		AddRecipientDetails.recipBankDetails(objReciDtls);
	...
	public static void tc020EmptyAccountNum_VD_AddRecip_CustSupport_FedWire() throws Exception {
		AddSenderDetails objSenderDtls = TestDataReader.loadSenderDetails("VD-RC-RTD-FW-000");
		AddRecipientDetails objReciDtls = TestDataReader.loadRecipientDetails_02("VD-RC-RTD-FW-020");
		AddSenderDetails.addRecipBtnClick_SelectDivision_TransferType_PmtNetwk(objSenderDtls);
		AddSenderDetails.enterSenderAccountNumber_DepOp004(objSenderDtls); 
		AddRecipientDetails.recipDetails2(objReciDtls);
		AddRecipientDetails.recipBankDetails(objReciDtls);
	...
	public static void tc021InvalidAccountNum_VD_AddRecip_CustSupport_FedWire() throws Exception {
		AddSenderDetails objSenderDtls = TestDataReader.loadSenderDetails("VD-RC-RTD-FW-000");
		AddRecipientDetails objReciDtls = TestDataReader.loadRecipientDetails_02("VD-RC-RTD-FW-021");
		AddSenderDetails.addRecipBtnClick_SelectDivision_TransferType_PmtNetwk(objSenderDtls);
		AddSenderDetails.enterSenderAccountNumber_DepOp004(objSenderDtls); 
		AddRecipientDetails.recipDetails2(objReciDtls);
		AddRecipientDetails.recipBankDetails(objReciDtls);
	...
	public static void tc022_EmptySenderAccNum_VD_AddRecip_CustSupport_FedWire() throws Exception {
		AddSenderDetails objSenderDtls = TestDataReader.loadSenderDetails("VD-RC-RTD-FW-022");
		AddSenderDetails.addRecipBtnClick_SelectDivision_TransferType_PmtNetwk(objSenderDtls);
		AddSenderDetails.enterSenderAccountNumber_DepOp004(objSenderDtls);
		ErrorMessageData objErrDtls = TestDataReader.loadErrorMsg();
		ValidationPage.continueClick_And_AssertingSingleErrorFieldMsg(objErrDtls.getEmptyAccNum());
	...
	public static void tc023_InvalidSenderAccNum_VD_AddRecip_CustSupport_FedWire() throws Exception {
		AddSenderDetails objSenderDtls = TestDataReader.loadSenderDetails("VD-RC-RTD-FW-023");
		AddSenderDetails.addRecipBtnClick_SelectDivision_TransferType_PmtNetwk(objSenderDtls);
		AddSenderDetails.enterSenderAccountNumber_DepOp004(objSenderDtls);
		ErrorMessageData objErrDtls = TestDataReader.loadErrorMsg();
		ValidationPage.continueClick_And_AssertingSingleErrorFieldMsg(objErrDtls.getInvalidAccNum());
