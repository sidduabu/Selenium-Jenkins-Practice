...
public class BoundaryValueAnalysis_DepOp_FedWire extends Utility {
	...
	public void startSuite() throws Exception {
		...
		AddSenderDetails objSenderDtls = TestDataReader.loadSenderDetails("BVA-Pmts-RTD-FW-000");
...
// =============>> Sender Account Number <<================
	...
	public static void tc001SenderAccNum_LessThan_4Digits_BVA_DepOp_RTD_FedWire() throws Exception {
		AddSenderDetails objSenderDtls = TestDataReader.loadSenderDetails("BVA-Pmts-RTD-FW-001");
		AddRecipientDetails objReciDtls = TestDataReader.loadRecipientDetails_02("BVA-Pmts-RTD-FW-000");
		AddSenderDetails.Clik_Transfers_Link_DepOp();
		AddSenderDetails.select_ClinetsRoutingNum(objSenderDtls);
	...
	@Test(testName = "Sender_AccNum--> With_Exact_4Digits", priority = 2)
	public void tc002SenderAccNum_With_Exact_4Digits_BVA_DepOp_RTD_FedWire() throws Exception {
		AddSenderDetails objSenderDtls = TestDataReader.loadSenderDetails("BVA-Pmts-RTD-FW-002");
		AddSenderDetails.Clik_Transfers_Link_DepOp();
		AddSenderDetails.select_ClinetsRoutingNum(objSenderDtls);
		AddSenderDetails.payBtnClick_SelectDivision_PmtNetwork(objSenderDtls);
		AddSenderDetails.enterSenderAndChannelDetails(objSenderDtls);
	...
	public void tc003SenderAccNum_With_Exact_34Digits_BVA_DepOp_RTD_FedWire() throws Exception {
		AddSenderDetails objSenderDtls = TestDataReader.loadSenderDetails("BVA-Pmts-RTD-FW-003");
		AddSenderDetails.Clik_Transfers_Link_DepOp();
		AddSenderDetails.select_ClinetsRoutingNum(objSenderDtls);
		AddSenderDetails.payBtnClick_SelectDivision_PmtNetwork(objSenderDtls);
		AddSenderDetails.enterSenderAndChannelDetails(objSenderDtls);
	...
	public static void tc004SenderAccNum_GreaterThan_34Digits_BVA_DepOp_RTD_FedWire() throws Exception {
		AddSenderDetails objSenderDtls = TestDataReader.loadSenderDetails("BVA-Pmts-RTD-FW-004");
		AddSenderDetails.Clik_Transfers_Link_DepOp();
		AddSenderDetails.select_ClinetsRoutingNum(objSenderDtls);
		AddSenderDetails.payBtnClick_SelectDivision_PmtNetwork(objSenderDtls);
		AddSenderDetails.enterSenderAndChannelDetails(objSenderDtls);
...
// =============>> Recipient Account Number <<================
	...
	public void tc005Recipient_AccNum_With_LessThan_4Digits_BVA_DepOp_RTD_FedWire() throws Exception {
		AddSenderDetails objSenderDtls = TestDataReader.loadSenderDetails("BVA-Pmts-RTD-FW-000");
		AddRecipientDetails objReciDtls = TestDataReader.loadRecipientDetails_02("BVA-Pmts-RTD-FW-005");
		AddSenderDetails.Clik_Transfers_Link_DepOp();
		AddSenderDetails.select_ClinetsRoutingNum(objSenderDtls);
		AddSenderDetails.payBtnClick_SelectDivision_PmtNetwork(objSenderDtls);
		AddSenderDetails.enterSenderAndChannelDetails(objSenderDtls);
	...
	public void tc006Recipient_AccNum_With_Exact_4Digits_BVA_DepOp_RTD_FedWire() throws Exception {
		AddSenderDetails objSenderDtls = TestDataReader.loadSenderDetails("BVA-Pmts-RTD-FW-000");
		AddRecipientDetails objReciDtls = TestDataReader.loadRecipientDetails_02("BVA-Pmts-RTD-FW-006");
		AddSenderDetails.Clik_Transfers_Link_DepOp();
		AddSenderDetails.select_ClinetsRoutingNum(objSenderDtls);
		AddSenderDetails.payBtnClick_SelectDivision_PmtNetwork(objSenderDtls);
		AddSenderDetails.enterSenderAndChannelDetails(objSenderDtls);
	...
	public void tc007Recipient_AccNum_With_Exact_34Digits_BVA_DepOp_RTD_FedWire() throws Exception {
		AddSenderDetails objSenderDtls = TestDataReader.loadSenderDetails("BVA-Pmts-RTD-FW-000");
		AddRecipientDetails objReciDtls = TestDataReader.loadRecipientDetails_02("BVA-Pmts-RTD-FW-007");
		AddSenderDetails.Clik_Transfers_Link_DepOp();
		AddSenderDetails.select_ClinetsRoutingNum(objSenderDtls);
		AddSenderDetails.payBtnClick_SelectDivision_PmtNetwork(objSenderDtls);
		AddSenderDetails.enterSenderAndChannelDetails(objSenderDtls);
	...
	public void tc008Recipient_AccNum_With_MoreThan_34Digits_BVA_DepOp_RTD_FedWire() throws Exception {
		AddSenderDetails objSenderDtls = TestDataReader.loadSenderDetails("BVA-Pmts-RTD-FW-000");
		AddRecipientDetails objReciDtls = TestDataReader.loadRecipientDetails_02("BVA-Pmts-RTD-FW-008");
		AddSenderDetails.Clik_Transfers_Link_DepOp();
		AddSenderDetails.select_ClinetsRoutingNum(objSenderDtls);
		AddSenderDetails.payBtnClick_SelectDivision_PmtNetwork(objSenderDtls);
		AddSenderDetails.enterSenderAndChannelDetails(objSenderDtls);
...
// =============================>> Recipient Name <<=========================================================================	
	...
	public void tc009RecipientName_LessThan_OneDigit_BVA_DepOp_RTD_FedWire() throws Exception {
		AddSenderDetails objSenderDtls = TestDataReader.loadSenderDetails("BVA-Pmts-RTD-FW-000");
		AddRecipientDetails objReciDtls = TestDataReader.loadRecipientDetails_02("BVA-Pmts-RTD-FW-009");
		AddSenderDetails.Clik_Transfers_Link_DepOp();
		AddSenderDetails.select_ClinetsRoutingNum(objSenderDtls);
		AddSenderDetails.payBtnClick_SelectDivision_PmtNetwork(objSenderDtls);
		AddSenderDetails.enterSenderAndChannelDetails(objSenderDtls);
	...
	public void tc010RecipientName_Exact_OneDigit_BVA_DepOp_RTD_FedWire() throws Exception {
		AddSenderDetails objSenderDtls = TestDataReader.loadSenderDetails("BVA-Pmts-RTD-FW-000");
		AddRecipientDetails objReciDtls = TestDataReader.loadRecipientDetails_02("BVA-Pmts-RTD-FW-010");
		AddSenderDetails.Clik_Transfers_Link_DepOp();
		AddSenderDetails.select_ClinetsRoutingNum(objSenderDtls);
		AddSenderDetails.payBtnClick_SelectDivision_PmtNetwork(objSenderDtls);
		AddSenderDetails.enterSenderAndChannelDetails(objSenderDtls);
	...
	@Test(testName = "Recipient_Name--> Exact  140 digit", priority = 11)
	public void tc011RecipientName_Exact_140Digit_BVA_DepOp_RTD_FedWire() throws Exception {
		AddSenderDetails objSenderDtls = TestDataReader.loadSenderDetails("BVA-Pmts-RTD-FW-000");
		AddRecipientDetails objReciDtls = TestDataReader.loadRecipientDetails_02("BVA-Pmts-RTD-FW-011");
		AddSenderDetails.Clik_Transfers_Link_DepOp();
		AddSenderDetails.select_ClinetsRoutingNum(objSenderDtls);
		AddSenderDetails.payBtnClick_SelectDivision_PmtNetwork(objSenderDtls);
		AddSenderDetails.enterSenderAndChannelDetails(objSenderDtls);
	...
	@Test(testName = "Recipient_Name--> greater than 140 digit", priority = 12)
	public void tc012RecipientName_GreaterThan_35Digit_BVA_DepOp_RTD_FedWire() throws Exception {
		AddSenderDetails objSenderDtls = TestDataReader.loadSenderDetails("BVA-Pmts-RTD-FW-000");
		AddRecipientDetails objReciDtls = TestDataReader.loadRecipientDetails_02("BVA-Pmts-RTD-FW-012");
		AddSenderDetails.Clik_Transfers_Link_DepOp();
		AddSenderDetails.select_ClinetsRoutingNum(objSenderDtls);
		AddSenderDetails.payBtnClick_SelectDivision_PmtNetwork(objSenderDtls);
		AddSenderDetails.enterSenderAndChannelDetails(objSenderDtls);
...
// =============================Routing Number =================================================
	...
	public void tc013RoutingNumber_LessThan_9Digits_BVA_DepOp_RTD_FedWire() throws Exception {
		AddSenderDetails objSenderDtls = TestDataReader.loadSenderDetails("BVA-Pmts-RTD-FW-000");
		AddRecipientDetails objReciDtls = TestDataReader.loadRecipientDetails_02("BVA-Pmts-RTD-FW-013");
		AddSenderDetails.Clik_Transfers_Link_DepOp();
		AddSenderDetails.select_ClinetsRoutingNum(objSenderDtls);
		AddSenderDetails.payBtnClick_SelectDivision_PmtNetwork(objSenderDtls);
		AddSenderDetails.enterSenderAndChannelDetails(objSenderDtls);
	...
	public void tc014RoutingNumber_Exact_9Digits_BVA_DepOp_RTD_FedWire() throws Exception {
		AddSenderDetails objSenderDtls = TestDataReader.loadSenderDetails("BVA-Pmts-RTD-FW-000");
		AddRecipientDetails objReciDtls = TestDataReader.loadRecipientDetails_02("BVA-Pmts-RTD-FW-014");
		AddSenderDetails.Clik_Transfers_Link_DepOp();
		AddSenderDetails.select_ClinetsRoutingNum(objSenderDtls);
		AddSenderDetails.payBtnClick_SelectDivision_PmtNetwork(objSenderDtls);
		AddSenderDetails.enterSenderAndChannelDetails(objSenderDtls);
	...
	public void tc015RoutingNumber_GreaterThan_9Digits_BVA_DepOp_RTD_FedWire() throws Exception {
		AddSenderDetails objSenderDtls = TestDataReader.loadSenderDetails("BVA-Pmts-RTD-FW-000");
		AddRecipientDetails objReciDtls = TestDataReader.loadRecipientDetails_02("BVA-Pmts-RTD-FW-015");
		AddSenderDetails.Clik_Transfers_Link_DepOp();
		AddSenderDetails.select_ClinetsRoutingNum(objSenderDtls);
		AddSenderDetails.payBtnClick_SelectDivision_PmtNetwork(objSenderDtls);
		AddSenderDetails.enterSenderAndChannelDetails(objSenderDtls);
...
//		public static void tc016Amount_LessThan_BVA_DepOp_RTD_FW() throws Exception {
//			AddSenderDetails objSenderDtls = TestDataReader.loadSenderDetails("BVA-Pmts-RTD-FW-000");
//			AddRecipientDetails objReciDtls = TestDataReader.loadRecipientDetails_02("BVA-Pmts-RTD-FW-016");
//			AddSenderDetails.Clik_Transfers_Link_DepOp();
//			AddSenderDetails.select_ClinetsRoutingNum(objSenderDtls);
//			AddSenderDetails.payBtnClick_SelectDivision_PmtNetwork(objSenderDtls);
//			AddSenderDetails.enterSenderAndChannelDetails(objSenderDtls);
...
//		}
//
//		@Test(testName = "Amount Exact 0.1", priority = 17)
//		public static void tc017Amount_ExactZeroPointOne_BVA_DepOp_RTD_FW() throws Exception {
//			AddSenderDetails objSenderDtls = TestDataReader.loadSenderDetails("BVA-Pmts-RTD-FW-000");
//			AddRecipientDetails objReciDtls = TestDataReader.loadRecipientDetails_02("BVA-Pmts-RTD-FW-017");
//			AddSenderDetails.Clik_Transfers_Link_DepOp();
//			AddSenderDetails.select_ClinetsRoutingNum(objSenderDtls);
//			AddSenderDetails.payBtnClick_SelectDivision_PmtNetwork(objSenderDtls);
//			AddSenderDetails.enterSenderAndChannelDetails(objSenderDtls);
...
//		}
//
//		@Test(testName = "Amount Exact 9999999999.99", priority = 18)
//		public static void tc018Amount_Exact9999999999_dot99_BVA_DepOp_RTD_FW() throws Exception {
//			AddSenderDetails objSenderDtls = TestDataReader.loadSenderDetails("BVA-Pmts-RTD-FW-000");
//			AddRecipientDetails objReciDtls = TestDataReader.loadRecipientDetails_02("BVA-Pmts-RTD-FW-018");
//			AddSenderDetails.Clik_Transfers_Link_DepOp();
//			AddSenderDetails.select_ClinetsRoutingNum(objSenderDtls);
//			AddSenderDetails.payBtnClick_SelectDivision_PmtNetwork(objSenderDtls);
//			AddSenderDetails.enterSenderAndChannelDetails(objSenderDtls);
...
//		}
//
//		@Test(testName = "Amount Greater Than 9999999999.99", priority = 19)
//		public static void tc019Amount_GreaterThan9999999999_dot99_BVA_DepOp_RTD_FW() throws Exception {
//			AddSenderDetails objSenderDtls = TestDataReader.loadSenderDetails("BVA-Pmts-RTD-FW-000");
//			AddRecipientDetails objReciDtls = TestDataReader.loadRecipientDetails_02("BVA-Pmts-RTD-FW-019");
//			AddSenderDetails.Clik_Transfers_Link_DepOp();
//			AddSenderDetails.select_ClinetsRoutingNum(objSenderDtls);
//			AddSenderDetails.payBtnClick_SelectDivision_PmtNetwork(objSenderDtls);
//			AddSenderDetails.enterSenderAndChannelDetails(objSenderDtls);
...
//============================= Recipient Phone Number =================================================
		...
		public void tc020PhoneNumber_LessThan_10Digits_BVA_DepOp_RTD_FW() throws Exception {
			AddSenderDetails objSenderDtls = TestDataReader.loadSenderDetails("BVA-Pmts-RTD-FW-000");
			AddRecipientDetails objReciDtls = TestDataReader.loadRecipientDetails_02("BVA-Pmts-RTD-FW-020");
			AddSenderDetails.Clik_Transfers_Link_DepOp();
			AddSenderDetails.select_ClinetsRoutingNum(objSenderDtls);
			AddSenderDetails.payBtnClick_SelectDivision_PmtNetwork(objSenderDtls);
			AddSenderDetails.enterSenderAndChannelDetails(objSenderDtls);
		...
		public void tc021PhoneNumber_Exact_10Digits_BVA_DepOp_RTD_FW() throws Exception {
			AddSenderDetails objSenderDtls = TestDataReader.loadSenderDetails("BVA-Pmts-RTD-FW-000");
			AddRecipientDetails objReciDtls = TestDataReader.loadRecipientDetails_02("BVA-Pmts-RTD-FW-021");
			AddSenderDetails.Clik_Transfers_Link_DepOp();
			AddSenderDetails.select_ClinetsRoutingNum(objSenderDtls);
			AddSenderDetails.payBtnClick_SelectDivision_PmtNetwork(objSenderDtls);
			AddSenderDetails.enterSenderAndChannelDetails(objSenderDtls);
		...
		public void tc022PhoneNumber_GreaterThan_10Digits_BVA_DepOp_RTD_FW() throws Exception {
			AddSenderDetails objSenderDtls = TestDataReader.loadSenderDetails("BVA-Pmts-RTD-FW-000");
			AddRecipientDetails objReciDtls = TestDataReader.loadRecipientDetails_02("BVA-Pmts-RTD-FW-022");
			AddSenderDetails.Clik_Transfers_Link_DepOp();
			AddSenderDetails.select_ClinetsRoutingNum(objSenderDtls);
			AddSenderDetails.payBtnClick_SelectDivision_PmtNetwork(objSenderDtls);
			AddSenderDetails.enterSenderAndChannelDetails(objSenderDtls);
