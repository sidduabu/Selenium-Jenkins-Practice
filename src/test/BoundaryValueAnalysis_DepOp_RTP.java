...
public class BoundaryValueAnalysis_DepOp_RTP extends Utility {
...
//		AddSenderDetails objSenderDtls = TestDataReader.loadSenderDetails("BVA-Pmts-RTD-RTP-000");
...
// =============>> Sender Account Number <<================	
	...
	public static void tc001SenderAccNum_LessThan_04Digits_BVA_DepOp_RTD_RTP() throws Exception {
		AddSenderDetails objSenderDtls = TestDataReader.loadSenderDetails("BVA-Pmts-RTD-RTP-001");
		AddRecipientDetails objReciDtls = TestDataReader.loadRecipientDetails_02("BVA-Pmts-RTD-RTP-000");
		AddSenderDetails.selectCustomerSupport();
		AddSenderDetails.Clik_Transfers_Link_DepOp();
		AddSenderDetails.select_ClinetsRoutingNum(objSenderDtls);
	...
	@Test(testName = "Sender_AccNum--> With_Exact_04_Digits", priority = 2)
	public void tc002SenderAccNum_With_Exact_04Digits_BVA_DepOp_RTD_RTP() throws Exception {
		AddSenderDetails objSenderDtls = TestDataReader.loadSenderDetails("BVA-Pmts-RTD-RTP-002");
		AddSenderDetails.selectCustomerSupport();
		AddSenderDetails.Clik_Transfers_Link_DepOp();
		AddSenderDetails.select_ClinetsRoutingNum(objSenderDtls);
		AddSenderDetails.payBtnClick_SelectDivision_PmtNetwork(objSenderDtls);
	...
	@Test(testName = "Sender_AccNum--> Exact_ThirtyFourDigits", priority = 3)
	public void tc003SenderAccNum_With_Exact_34FourDigits_BVA_DepOp_RTD_RTP() throws Exception {
		AddSenderDetails objSenderDtls = TestDataReader.loadSenderDetails("BVA-Pmts-RTD-RTP-003");
		AddSenderDetails.selectCustomerSupport();
		AddSenderDetails.Clik_Transfers_Link_DepOp();
		AddSenderDetails.select_ClinetsRoutingNum(objSenderDtls);
		AddSenderDetails.payBtnClick_SelectDivision_PmtNetwork(objSenderDtls);
	...
	@Test(testName = "Sender_AccNum--> GreaterThan_ThirtyFourDigits", priority = 4)
	public static void tc004SenderAccNum_GreaterThan_34Digits_BVA_DepOp_RTD_RTP() throws Exception {
		AddSenderDetails objSenderDtls = TestDataReader.loadSenderDetails("BVA-Pmts-RTD-RTP-004");
		AddSenderDetails.selectCustomerSupport();
		AddSenderDetails.Clik_Transfers_Link_DepOp();
		AddSenderDetails.select_ClinetsRoutingNum(objSenderDtls);
		AddSenderDetails.payBtnClick_SelectDivision_PmtNetwork(objSenderDtls);
...
// =============>> Recipient Account Number <<================		
	...
	@Test(testName = "Recipient_AccNum--> Less than four digits", priority = 5)
	public void tc005Recipient_AccNum_With_LessThan_04Digits_BVA_DepOp_RTD_RTP() throws Exception {
		AddSenderDetails objSenderDtls = TestDataReader.loadSenderDetails("BVA-Pmts-RTD-RTP-000");
		AddRecipientDetails objReciDtls = TestDataReader.loadRecipientDetails_02("BVA-Pmts-RTD-RTP-005");
		AddSenderDetails.selectCustomerSupport();
		AddSenderDetails.Clik_Transfers_Link_DepOp();
		AddSenderDetails.select_ClinetsRoutingNum(objSenderDtls);
		AddSenderDetails.payBtnClick_SelectDivision_PmtNetwork(objSenderDtls);
	...
	@Test(testName = "Recipient_AccNum--> Exact four digits", priority = 6)
	public void tc006Recipient_AccNum_With_Exact_04Digits_BVA_DepOp_RTD_RTP() throws Exception {
		AddSenderDetails objSenderDtls = TestDataReader.loadSenderDetails("BVA-Pmts-RTD-RTP-000");
		AddRecipientDetails objReciDtls = TestDataReader.loadRecipientDetails_02("BVA-Pmts-RTD-RTP-006");
		AddSenderDetails.selectCustomerSupport();
		AddSenderDetails.Clik_Transfers_Link_DepOp();
		AddSenderDetails.select_ClinetsRoutingNum(objSenderDtls);
		AddSenderDetails.payBtnClick_SelectDivision_PmtNetwork(objSenderDtls);
	...
	@Test(testName = "Recipient_AccNum--> Exact Thirtyfour digits", priority = 7)
	public void tc007Recipient_AccNum_With_Exact_34Digits_BVA_DepOp_RTD_RTP() throws Exception {
		AddSenderDetails objSenderDtls = TestDataReader.loadSenderDetails("BVA-Pmts-RTD-RTP-000");
		AddRecipientDetails objReciDtls = TestDataReader.loadRecipientDetails_02("BVA-Pmts-RTD-RTP-007");
		AddSenderDetails.selectCustomerSupport();
		AddSenderDetails.Clik_Transfers_Link_DepOp();
		AddSenderDetails.select_ClinetsRoutingNum(objSenderDtls);
		AddSenderDetails.payBtnClick_SelectDivision_PmtNetwork(objSenderDtls);
	...
	@Test(testName = "Recipient_AccNum--> More than Thirtyfour digits", priority = 8)
	public void tc008Recipient_AccNum_With_MoreThan_34Digits_BVA_DepOp_RTD_RTP() throws Exception {
		AddSenderDetails objSenderDtls = TestDataReader.loadSenderDetails("BVA-Pmts-RTD-RTP-000");
		AddRecipientDetails objReciDtls = TestDataReader.loadRecipientDetails_02("BVA-Pmts-RTD-RTP-008");
		AddSenderDetails.selectCustomerSupport();
		AddSenderDetails.Clik_Transfers_Link_DepOp();
		AddSenderDetails.select_ClinetsRoutingNum(objSenderDtls);
		AddSenderDetails.payBtnClick_SelectDivision_PmtNetwork(objSenderDtls);
...
// =============================>> Recipient Name <<=========================================================================	
	...
	public void tc009RecipientName_LessThan_OneDigit_BVA_DepOp_RTD_RTP() throws Exception {
		AddSenderDetails objSenderDtls = TestDataReader.loadSenderDetails("BVA-Pmts-RTD-RTP-000");
		AddRecipientDetails objReciDtls = TestDataReader.loadRecipientDetails_02("BVA-Pmts-RTD-RTP-009");
		AddSenderDetails.selectCustomerSupport();
		AddSenderDetails.Clik_Transfers_Link_DepOp();
		AddSenderDetails.select_ClinetsRoutingNum(objSenderDtls);
		AddSenderDetails.payBtnClick_SelectDivision_PmtNetwork(objSenderDtls);
	...
	public void tc010RecipientName_Exact_OneDigit_BVA_DepOp_RTD_RTP() throws Exception {
		AddSenderDetails objSenderDtls = TestDataReader.loadSenderDetails("BVA-Pmts-RTD-RTP-000");
		AddRecipientDetails objReciDtls = TestDataReader.loadRecipientDetails_02("BVA-Pmts-RTD-RTP-010");
		AddSenderDetails.selectCustomerSupport();
		AddSenderDetails.Clik_Transfers_Link_DepOp();
		AddSenderDetails.select_ClinetsRoutingNum(objSenderDtls);
		AddSenderDetails.payBtnClick_SelectDivision_PmtNetwork(objSenderDtls);
	...
	public void tc011RecipientName_Exact_60Digit_BVA_DepOp_RTD_RTP() throws Exception {
		AddSenderDetails objSenderDtls = TestDataReader.loadSenderDetails("BVA-Pmts-RTD-RTP-000");
		AddRecipientDetails objReciDtls = TestDataReader.loadRecipientDetails_02("BVA-Pmts-RTD-RTP-011");
		AddSenderDetails.selectCustomerSupport();
		AddSenderDetails.Clik_Transfers_Link_DepOp();
		AddSenderDetails.select_ClinetsRoutingNum(objSenderDtls);
		AddSenderDetails.payBtnClick_SelectDivision_PmtNetwork(objSenderDtls);
	...
	public void tc012RecipientName_GreaterThan_60Digit_BVA_DepOp_RTD_RTP() throws Exception {
		AddSenderDetails objSenderDtls = TestDataReader.loadSenderDetails("BVA-Pmts-RTD-RTP-000");
		AddRecipientDetails objReciDtls = TestDataReader.loadRecipientDetails_02("BVA-Pmts-RTD-RTP-012");
		AddSenderDetails.selectCustomerSupport();
		AddSenderDetails.Clik_Transfers_Link_DepOp();
		AddSenderDetails.select_ClinetsRoutingNum(objSenderDtls);
		AddSenderDetails.payBtnClick_SelectDivision_PmtNetwork(objSenderDtls);
...
//============================= Routing Number =================================================
	...
	public void tc013RoutingNumber_LessThan_9Digits_BVA_DepOp_RTD_RTP() throws Exception {
		AddSenderDetails objSenderDtls = TestDataReader.loadSenderDetails("BVA-Pmts-RTD-RTP-000");
		AddRecipientDetails objReciDtls = TestDataReader.loadRecipientDetails_02("BVA-Pmts-RTD-RTP-013");
		AddSenderDetails.selectCustomerSupport();
		AddSenderDetails.Clik_Transfers_Link_DepOp();
		AddSenderDetails.select_ClinetsRoutingNum(objSenderDtls);
		AddSenderDetails.payBtnClick_SelectDivision_PmtNetwork(objSenderDtls);
	...
	public void tc014RoutingNumber_Exact_9Digits_BVA_DepOp_RTD_RTP() throws Exception {
		AddSenderDetails objSenderDtls = TestDataReader.loadSenderDetails("BVA-Pmts-RTD-RTP-000");
		AddRecipientDetails objReciDtls = TestDataReader.loadRecipientDetails_02("BVA-Pmts-RTD-RTP-014");
		AddSenderDetails.selectCustomerSupport();
		AddSenderDetails.Clik_Transfers_Link_DepOp();
		AddSenderDetails.select_ClinetsRoutingNum(objSenderDtls);
		AddSenderDetails.payBtnClick_SelectDivision_PmtNetwork(objSenderDtls);
	...
	public void tc015RoutingNumber_GreaterThan_9Digits_BVA_DepOp_RTD_RTP() throws Exception {
		AddSenderDetails objSenderDtls = TestDataReader.loadSenderDetails("BVA-Pmts-RTD-RTP-000");
		AddRecipientDetails objReciDtls = TestDataReader.loadRecipientDetails_02("BVA-Pmts-RTD-RTP-015");
		AddSenderDetails.selectCustomerSupport();
		AddSenderDetails.Clik_Transfers_Link_DepOp();
		AddSenderDetails.select_ClinetsRoutingNum(objSenderDtls);
		AddSenderDetails.payBtnClick_SelectDivision_PmtNetwork(objSenderDtls);
...
//	public static void tc016Amount_LessThan_BVA_DepOp_RTD_RTP() throws Exception {
//		AddSenderDetails objSenderDtls = TestDataReader.loadSenderDetails("BVA-Pmts-RTD-RTP-000");
//		AddRecipientDetails objReciDtls = TestDataReader.loadRecipientDetails_02("BVA-Pmts-RTD-RTP-016");
//		AddSenderDetails.selectCustomerSupport();
//		AddSenderDetails.Clik_Transfers_Link_DepOp();
//		AddSenderDetails.select_ClinetsRoutingNum(objSenderDtls);
//		AddSenderDetails.payBtnClick_SelectDivision_PmtNetwork(objSenderDtls);
...
//	public static void tc017Amount_Exact_BVA_DepOp_RTD_RTP() throws Exception {
//		AddSenderDetails objSenderDtls = TestDataReader.loadSenderDetails("BVA-Pmts-RTD-RTP-000");
//		AddRecipientDetails objReciDtls = TestDataReader.loadRecipientDetails_02("BVA-Pmts-RTD-RTP-017");
//		AddSenderDetails.selectCustomerSupport();
//		AddSenderDetails.Clik_Transfers_Link_DepOp();
//		AddSenderDetails.select_ClinetsRoutingNum(objSenderDtls);
//		AddSenderDetails.payBtnClick_SelectDivision_PmtNetwork(objSenderDtls);
...
//	public static void tc018Amount_Exact_BVA_DepOp_RTD_RTP() throws Exception {
//		AddSenderDetails objSenderDtls = TestDataReader.loadSenderDetails("BVA-Pmts-RTD-RTP-000");
//		AddRecipientDetails objReciDtls = TestDataReader.loadRecipientDetails_02("BVA-Pmts-RTD-RTP-018");
//		AddSenderDetails.selectCustomerSupport();
//		AddSenderDetails.Clik_Transfers_Link_DepOp();
//		AddSenderDetails.select_ClinetsRoutingNum(objSenderDtls);
//		AddSenderDetails.payBtnClick_SelectDivision_PmtNetwork(objSenderDtls);
...
//		AddSenderDetails.Clik_Transfers_Link_DepOp();
//		AddSenderDetails.select_ClinetsRoutingNum(objSenderDtls);
//		AddSenderDetails.partialApprovePayment(ConfirmationNo);
//		AddSenderDetails.logOff();
...
//		AddSenderDetails.Clik_Transfers_Link_DepOp();
//		AddSenderDetails.select_ClinetsRoutingNum(objSenderDtls);
//		AddSenderDetails.approvingPayment(ConfirmationNo);
//	}
//
//	@Test(testName = "Amount Greater Than", priority = 19)
//	public static void tc019Amount_GreaterThan() throws Exception {
//		AddSenderDetails objSenderDtls = TestDataReader.loadSenderDetails("BVA-Pmts-RTD-RTP-000");
//		AddRecipientDetails objReciDtls = TestDataReader.loadRecipientDetails_02("BVA-Pmts-RTD-RTP-019");
//		AddSenderDetails.selectCustomerSupport();
//		AddSenderDetails.Clik_Transfers_Link_DepOp();
//		AddSenderDetails.select_ClinetsRoutingNum(objSenderDtls);
//		AddSenderDetails.payBtnClick_SelectDivision_PmtNetwork(objSenderDtls);
...
////		AddRecipientDetails.currentBalanceDisplay_DepOp();
//		ErrorMessageData objErrDtls = TestDataReader.loadErrorMsg();
//		ValidationPage.assertErrorFieldMsg1(objErrDtls.getMaxAmountError_Transfers_RTP());
//
//	}
...
//============================= Recipient Phone Number =================================================
	...
	public void tc020PhoneNumber_LessThan_10Digits_BVA_DepOp_RTD_RTP() throws Exception {
		AddSenderDetails objSenderDtls = TestDataReader.loadSenderDetails("BVA-Pmts-RTD-RTP-000");
		AddRecipientDetails objReciDtls = TestDataReader.loadRecipientDetails_02("BVA-Pmts-RTD-RTP-020");
		AddSenderDetails.selectCustomerSupport();
		AddSenderDetails.Clik_Transfers_Link_DepOp();
		AddSenderDetails.select_ClinetsRoutingNum(objSenderDtls);
		AddSenderDetails.payBtnClick_SelectDivision_PmtNetwork(objSenderDtls);
	...
	public void tc021PhoneNumber_Exact_10Digits_BVA_DepOp_RTD_RTP() throws Exception {
		AddSenderDetails objSenderDtls = TestDataReader.loadSenderDetails("BVA-Pmts-RTD-RTP-000");
		AddRecipientDetails objReciDtls = TestDataReader.loadRecipientDetails_02("BVA-Pmts-RTD-RTP-021");
		AddSenderDetails.selectCustomerSupport();
		AddSenderDetails.Clik_Transfers_Link_DepOp();
		AddSenderDetails.select_ClinetsRoutingNum(objSenderDtls);
		AddSenderDetails.payBtnClick_SelectDivision_PmtNetwork(objSenderDtls);
	...
	public void tc022PhoneNumber_GreaterThan_10Digits_BVA_DepOp_RTD_RTP() throws Exception {
		AddSenderDetails objSenderDtls = TestDataReader.loadSenderDetails("BVA-Pmts-RTD-RTP-000");
		AddRecipientDetails objReciDtls = TestDataReader.loadRecipientDetails_02("BVA-Pmts-RTD-RTP-022");
		AddSenderDetails.selectCustomerSupport();
		AddSenderDetails.Clik_Transfers_Link_DepOp();
		AddSenderDetails.select_ClinetsRoutingNum(objSenderDtls);
		AddSenderDetails.payBtnClick_SelectDivision_PmtNetwork(objSenderDtls);
