...
public class HotList_FI extends Utility {
...
// Payment Link Click
	...
	@Test(testName = "HotList BankAccNum (MortgageDivision-RTP)", priority = 1)
	public void tc001BankAccNum_HotList_FI_MGD_RTP() throws Exception {
		AddSenderDetails objSenderDtls = TestDataReader.loadSenderDetails("HL-MGD-RTP");
	...
	@Test(testName = "HotList Phone Number (MortgageDivision-RTP)", priority = 2)
	public void tc002PhoneNum_HotList_FI_MGD_RTP() throws Exception {
		AddSenderDetails objSenderDtls = TestDataReader.loadSenderDetails("HL-MGD-RTP");
		AddSenderDetails.select_ClinetsRoutingNum(objSenderDtls);
		AddSenderDetails.payBtnClick_SelectDivision_PmtNetwork(objSenderDtls);
		AddSenderDetails.enterSenderDetails(objSenderDtls);
	...
	@Test(testName = "HotList Email (MortgageDivision-RTP)", priority = 3)
	public void tc003Email_HotList_FI_MGD_RTP() throws Exception {
		AddSenderDetails objSenderDtls = TestDataReader.loadSenderDetails("HL-MGD-RTP");
		AddSenderDetails.select_ClinetsRoutingNum(objSenderDtls);
		AddSenderDetails.payBtnClick_SelectDivision_PmtNetwork(objSenderDtls);
		AddSenderDetails.enterSenderDetails(objSenderDtls);
	...
	@Test(testName = "HotList BankAccNum (MortgageDivision-FedNow)", priority = 4)
	public void tc004BankAccNum_HotList_FI_MGD_FedNow() throws Exception {
		AddSenderDetails objSenderDtls = TestDataReader.loadSenderDetails("HL-MGD-FN");
		AddSenderDetails.select_ClinetsRoutingNum(objSenderDtls);
		AddSenderDetails.payBtnClick_SelectDivision_PmtNetwork(objSenderDtls);
		AddSenderDetails.enterSenderDetails(objSenderDtls);
	...
	@Test(testName = "HotList Phone Number (MortgageDivision-FedNow)", priority = 5)
	public void tc005PhoneNum_HotList_FI_MGD_FedNow() throws Exception {
		AddSenderDetails objSenderDtls = TestDataReader.loadSenderDetails("HL-MGD-FN");
		AddSenderDetails.select_ClinetsRoutingNum(objSenderDtls);
		AddSenderDetails.payBtnClick_SelectDivision_PmtNetwork(objSenderDtls);
		AddSenderDetails.enterSenderDetails(objSenderDtls);
	...
	@Test(testName = "HotList Email (MortgageDivision-FedNow)", priority = 6)
	public void tc006Email_HotList_FI_MGD_FedNow() throws Exception {
		AddSenderDetails objSenderDtls = TestDataReader.loadSenderDetails("HL-MGD-FN");
		AddSenderDetails.select_ClinetsRoutingNum(objSenderDtls);
		AddSenderDetails.payBtnClick_SelectDivision_PmtNetwork(objSenderDtls);
		AddSenderDetails.enterSenderDetails(objSenderDtls);
	...
	@Test(testName = "HotList BankAccNum (MortgageDivision-FedWire)", priority = 7)
	public void tc007BankAccNum_HotList_FI_MGD_FedWire() throws Exception {
		AddSenderDetails objSenderDtls = TestDataReader.loadSenderDetails("HL-MGD-FW");
		AddSenderDetails.select_ClinetsRoutingNum(objSenderDtls);
		AddSenderDetails.payBtnClick_SelectDivision_PmtNetwork(objSenderDtls);
		AddSenderDetails.enterSenderDetails(objSenderDtls);
	...
	@Test(testName = "HotList Phone Number (MortgageDivision-FedWire)", priority = 8)
	public void tc008PhoneNum_HotList_FI_MGD_FedWire() throws Exception {
		AddSenderDetails objSenderDtls = TestDataReader.loadSenderDetails("HL-MGD-FW");
		AddSenderDetails.select_ClinetsRoutingNum(objSenderDtls);
		AddSenderDetails.payBtnClick_SelectDivision_PmtNetwork(objSenderDtls);
		AddSenderDetails.enterSenderDetails(objSenderDtls);
	...
	@Test(testName = "HotList Email (MortgageDivision-FedWire)", priority = 9)
	public void tc009Email_HotList_FI_MGD_FedWire() throws Exception {
		AddSenderDetails objSenderDtls = TestDataReader.loadSenderDetails("HL-MGD-FW");
		AddSenderDetails.select_ClinetsRoutingNum(objSenderDtls);
		AddSenderDetails.payBtnClick_SelectDivision_PmtNetwork(objSenderDtls);
		AddSenderDetails.enterSenderDetails(objSenderDtls);
...
//=============================================================================================================================================	
	...
	@Test(testName = "HotList BankAccNum (AutoLoanDivision-RTP)", priority = 10)
	public void tc010BankAccNum_HotList_FI_ALD_RTP() throws Exception {
		AddSenderDetails objSenderDtls = TestDataReader.loadSenderDetails("HL-ALD-RTP");
		AddSenderDetails.select_ClinetsRoutingNum(objSenderDtls);
		AddSenderDetails.payBtnClick_SelectDivision_PmtNetwork(objSenderDtls);
		AddSenderDetails.enterSenderDetails(objSenderDtls);
		AddRecipientDetails objReciDtls = TestDataReader.loadRecipientDetails("HL-RTP-001");
	...
	@Test(testName = "HotList Phone Number (AutoLoanDivision-RTP)", priority = 11)
	public void tc011PhoneNum_HotList_FI_ALD_RTP() throws Exception {
		AddSenderDetails objSenderDtls = TestDataReader.loadSenderDetails("HL-ALD-RTP");
		AddSenderDetails.select_ClinetsRoutingNum(objSenderDtls);
		AddSenderDetails.payBtnClick_SelectDivision_PmtNetwork(objSenderDtls);
		AddSenderDetails.enterSenderDetails(objSenderDtls);
	...
	@Test(testName = "HotList Email (AutoLoanDivision-RTP)", priority = 12)
	public void tc012Email_HotList_FI_ALD_RTP() throws Exception {
		AddSenderDetails objSenderDtls = TestDataReader.loadSenderDetails("HL-ALD-RTP");
		AddSenderDetails.select_ClinetsRoutingNum(objSenderDtls);
		AddSenderDetails.payBtnClick_SelectDivision_PmtNetwork(objSenderDtls);
		AddSenderDetails.enterSenderDetails(objSenderDtls);
	...
	@Test(testName = "HotList BankAccNum (AutoLoanDivision-FN)", priority = 13)
	public void tc013BankAccNum_HotList_FI_ALD_FedNow() throws Exception {
		AddSenderDetails objSenderDtls = TestDataReader.loadSenderDetails("HL-ALD-FN");
		AddSenderDetails.select_ClinetsRoutingNum(objSenderDtls);
		AddSenderDetails.payBtnClick_SelectDivision_PmtNetwork(objSenderDtls);
		AddSenderDetails.enterSenderDetails(objSenderDtls);
		AddRecipientDetails objReciDtls = TestDataReader.loadRecipientDetails("HL-FN-001");
	...
	@Test(testName = "HotList Phone Number (AutoLoanDivision-FN)", priority = 14)
	public void tc014PhoneNum_HotList_FI_ALD_FedNow() throws Exception {
		AddSenderDetails objSenderDtls = TestDataReader.loadSenderDetails("HL-ALD-FN");
		AddSenderDetails.select_ClinetsRoutingNum(objSenderDtls);
		AddSenderDetails.payBtnClick_SelectDivision_PmtNetwork(objSenderDtls);
		AddSenderDetails.enterSenderDetails(objSenderDtls);
	...
	@Test(testName = "HotList Email (AutoLoanDivision-FN)", priority = 15)
	public void tc015Email_HotList_FI_ALD_FedNow() throws Exception {
		AddSenderDetails objSenderDtls = TestDataReader.loadSenderDetails("HL-ALD-FN");
		AddSenderDetails.select_ClinetsRoutingNum(objSenderDtls);
		AddSenderDetails.payBtnClick_SelectDivision_PmtNetwork(objSenderDtls);
		AddSenderDetails.enterSenderDetails(objSenderDtls);
	...
	@Test(testName = "HotList BankAccNum (AutoLoanDivision-FedWire)", priority = 16)
	public void tc016BankAccNum_HotList_FI_ALD_FedWire() throws Exception {
		AddSenderDetails objSenderDtls = TestDataReader.loadSenderDetails("HL-ALD-FW");
		AddSenderDetails.select_ClinetsRoutingNum(objSenderDtls);
		AddSenderDetails.payBtnClick_SelectDivision_PmtNetwork(objSenderDtls);
		AddSenderDetails.enterSenderDetails(objSenderDtls);
		AddRecipientDetails objReciDtls = TestDataReader.loadRecipientDetails("HL-FW-001");
	...
	@Test(testName = "HotList Phone Number (AutoLoanDivision-FedWire)", priority = 17)
	public void tc017PhoneNum_HotList_FI_ALD_FedWire() throws Exception {
		AddSenderDetails objSenderDtls = TestDataReader.loadSenderDetails("HL-ALD-FW");
		AddSenderDetails.select_ClinetsRoutingNum(objSenderDtls);
		AddSenderDetails.payBtnClick_SelectDivision_PmtNetwork(objSenderDtls);
		AddSenderDetails.enterSenderDetails(objSenderDtls);
	...
	@Test(testName = "HotList Email (AutoLoanDivision-FedWire)", priority = 18)
	public void tc018Email_HotList_FI_ALD_FedWire() throws Exception {
		AddSenderDetails objSenderDtls = TestDataReader.loadSenderDetails("HL-ALD-FW");
		AddSenderDetails.select_ClinetsRoutingNum(objSenderDtls);
		AddSenderDetails.payBtnClick_SelectDivision_PmtNetwork(objSenderDtls);
		AddSenderDetails.enterSenderDetails(objSenderDtls);
