...
public class Validation_FI_AddRecipient_FedWire  extends Utility {
	...
	public static void tc01_EmptyDivision_VD_AddRecip_FI_FedWire() throws Exception {
		AddSenderDetails objSenderDtls=TestDataReader.loadSenderDetails("VD-RC-MGD-FW-001");
	...
	public static void tc02EmptyTransferType_VD_AddRecip_FI_FedWire() throws Exception{
		AddSenderDetails objSenderDtls=TestDataReader.loadSenderDetails("VD-RC-MGD-FW-002");
		AddSenderDetails.select_ClinetsRoutingNum(objSenderDtls);
		AddSenderDetails.addRecipBtnClick_SelectDivision_TransferType_PmtNetwk(objSenderDtls);
...
//	public static void tc03EmptyPaymentMethod_VD_AddRecip_FI_FedWire() throws Exception {
//		AddSenderDetails objSenderDtls=TestDataReader.loadSenderDetails("VD-RC-MGD-FW-003");
//		AddSenderDetails.select_DivRoutingNum(objSenderDtls);
//		AddSenderDetails.addRecipBtnClick_SelectDivision_TransferType_PmtNetwk(objSenderDtls);
//		AddRecipientDetails objReciDtls=TestDataReader.loadRecipientDetails_02("VD-RC-MGD-FW-000");
...
//	public static void tc04EmptyRecipientType_VD_AddRecip_FI_FedWire() throws Exception {
//		AddSenderDetails objSenderDtls=TestDataReader.loadSenderDetails("VD-RC-MGD-FW-004");
//		AddSenderDetails.select_DivRoutingNum(objSenderDtls);
//		AddSenderDetails.addRecipBtnClick_SelectDivision_TransferType_PmtNetwk(objSenderDtls);
//		ErrorMessageData objErrDtls=TestDataReader.loadErrorMsg();
...
//	}	
	...
	public static void tc05InvalidNickname_VD_AddRecip_FI_FedWire()throws Exception {
		AddSenderDetails objSenderDtls=TestDataReader.loadSenderDetails("VD-RC-MGD-FW-000");
		AddSenderDetails.select_ClinetsRoutingNum(objSenderDtls);
		AddSenderDetails.addRecipBtnClick_SelectDivision_TransferType_PmtNetwk(objSenderDtls);
		AddRecipientDetails objReciDtls=TestDataReader.loadRecipientDetails_02("VD-RC-MGD-FW-005");
		AddRecipientDetails.recipDetails(objReciDtls);
		AddRecipientDetails.recipBankDetails(objReciDtls);
	...
	public static void tc06EmptyRecipientName_VD_AddRecip_FI_FedWire()throws Exception {
		AddSenderDetails objSenderDtls=TestDataReader.loadSenderDetails("VD-RC-MGD-FW-000");
		AddSenderDetails.select_ClinetsRoutingNum(objSenderDtls);
		AddSenderDetails.addRecipBtnClick_SelectDivision_TransferType_PmtNetwk(objSenderDtls);
		AddRecipientDetails objReciDtls=TestDataReader.loadRecipientDetails_02("VD-RC-MGD-FW-006");
		AddRecipientDetails.recipDetails(objReciDtls);
		AddRecipientDetails.recipBankDetails(objReciDtls);
		AddRecipientDetails.enterRecipientAddressDetailsInAllIndividualFields( objReciDtls);
		ErrorMessageData objErrDtls=TestDataReader.loadErrorMsg();
	...
	public static void tc07InvalidRecipientName_VD_AddRecip_FI_FedWire() throws Exception {
		AddSenderDetails objSenderDtls=TestDataReader.loadSenderDetails("VD-RC-MGD-FW-000");
		AddSenderDetails.select_ClinetsRoutingNum(objSenderDtls);
		AddSenderDetails.addRecipBtnClick_SelectDivision_TransferType_PmtNetwk(objSenderDtls);
		AddRecipientDetails objReciDtls=TestDataReader.loadRecipientDetails_02("VD-RC-MGD-FW-007");
		AddRecipientDetails.recipDetails(objReciDtls);
		AddRecipientDetails.recipBankDetails(objReciDtls);
		AddRecipientDetails.enterRecipientAddressDetailsInAllIndividualFields( objReciDtls);
		ErrorMessageData objErrDtls=TestDataReader.loadErrorMsg();
	...
	public static void tc08EmptyAddressLine_VD_AddRecip_FI_FedWire()throws Exception {
		AddSenderDetails objSenderDtls=TestDataReader.loadSenderDetails("VD-RC-MGD-FW-000");
		AddSenderDetails.select_ClinetsRoutingNum(objSenderDtls);
		AddSenderDetails.addRecipBtnClick_SelectDivision_TransferType_PmtNetwk(objSenderDtls);
		AddRecipientDetails objReciDtls=TestDataReader.loadRecipientDetails_02("VD-RC-MGD-FW-008");
		AddRecipientDetails.recipDetails(objReciDtls);
		AddRecipientDetails.recipBankDetails(objReciDtls);
		AddRecipientDetails.enterRecipientAddressDetailsInAllIndividualFields( objReciDtls);
	...
	public static void tc09InvalidAddressLine_VD_AddRecip_FI_FedWire()throws Exception {
		AddSenderDetails objSenderDtls=TestDataReader.loadSenderDetails("VD-RC-MGD-FW-000");
		AddSenderDetails.select_ClinetsRoutingNum(objSenderDtls);
		AddSenderDetails.addRecipBtnClick_SelectDivision_TransferType_PmtNetwk(objSenderDtls);
		AddRecipientDetails objReciDtls=TestDataReader.loadRecipientDetails_02("VD-RC-MGD-FW-009");
		AddRecipientDetails.recipDetails(objReciDtls);
		AddRecipientDetails.recipBankDetails(objReciDtls);
		AddRecipientDetails.enterRecipientAddressDetailsInAllIndividualFields( objReciDtls);
		ErrorMessageData objErrDtls=TestDataReader.loadErrorMsg();
	...
	public static void tc010EmptyTownName_VD_AddRecip_FI_FedWire() throws Exception{
		AddSenderDetails objSenderDtls=TestDataReader.loadSenderDetails("VD-RC-MGD-FW-000");
		AddSenderDetails.select_ClinetsRoutingNum(objSenderDtls);
		AddSenderDetails.addRecipBtnClick_SelectDivision_TransferType_PmtNetwk(objSenderDtls);
		AddRecipientDetails objReciDtls=TestDataReader.loadRecipientDetails_02("VD-RC-MGD-FW-010");
		AddRecipientDetails.recipDetails(objReciDtls);
		AddRecipientDetails.recipBankDetails(objReciDtls);
		AddRecipientDetails.enterRecipientAddressDetailsInAllIndividualFields( objReciDtls);
		ErrorMessageData objErrDtls=TestDataReader.loadErrorMsg();
	...
	public static void tc011InvalidTownName_VD_AddRecip_FI_FedWire() throws Exception{
		AddSenderDetails objSenderDtls=TestDataReader.loadSenderDetails("VD-RC-MGD-FW-000");
		AddSenderDetails.select_ClinetsRoutingNum(objSenderDtls);
		AddSenderDetails.addRecipBtnClick_SelectDivision_TransferType_PmtNetwk(objSenderDtls);
		AddRecipientDetails objReciDtls=TestDataReader.loadRecipientDetails_02("VD-RC-MGD-FW-011");
		AddRecipientDetails.recipDetails(objReciDtls);
		AddRecipientDetails.recipBankDetails(objReciDtls);
		AddRecipientDetails.enterRecipientAddressDetailsInAllIndividualFields( objReciDtls);
		ErrorMessageData objErrDtls=TestDataReader.loadErrorMsg();
	...
	public static void tc012EmptyState_VD_AddRecip_FI_FedWire()throws Exception {
		AddSenderDetails objSenderDtls=TestDataReader.loadSenderDetails("VD-RC-MGD-FW-000");
		AddSenderDetails.select_ClinetsRoutingNum(objSenderDtls);
		AddSenderDetails.addRecipBtnClick_SelectDivision_TransferType_PmtNetwk(objSenderDtls);
		AddRecipientDetails objReciDtls=TestDataReader.loadRecipientDetails_02("VD-RC-MGD-FW-012");
		AddRecipientDetails.recipDetails(objReciDtls);
		AddRecipientDetails.recipBankDetails(objReciDtls);
		AddRecipientDetails.enterRecipientAddressDetailsInAllIndividualFields( objReciDtls);
		ErrorMessageData objErrDtls=TestDataReader.loadErrorMsg();
	...
	public static void tc013EmptyCountry_VD_AddRecip_FI_FedWire()throws Exception {
		AddSenderDetails objSenderDtls=TestDataReader.loadSenderDetails("VD-RC-MGD-FW-000");
		AddSenderDetails.select_ClinetsRoutingNum(objSenderDtls);
		AddSenderDetails.addRecipBtnClick_SelectDivision_TransferType_PmtNetwk(objSenderDtls);
		AddRecipientDetails objReciDtls=TestDataReader.loadRecipientDetails_02("VD-RC-MGD-FW-013");
		AddRecipientDetails.recipDetails(objReciDtls);
		AddRecipientDetails.recipBankDetails(objReciDtls);
		AddRecipientDetails.enterRecipientAddressDetailsInAllIndividualFields( objReciDtls);
		ErrorMessageData objErrDtls=TestDataReader.loadErrorMsg();
	...
	public static void tc014EmptyZip_VD_AddRecip_FI_FedWire() throws Exception{
		AddSenderDetails objSenderDtls=TestDataReader.loadSenderDetails("VD-RC-MGD-FW-000");
		AddSenderDetails.select_ClinetsRoutingNum(objSenderDtls);
		AddSenderDetails.addRecipBtnClick_SelectDivision_TransferType_PmtNetwk(objSenderDtls);
		AddRecipientDetails objReciDtls=TestDataReader.loadRecipientDetails_02("VD-RC-MGD-FW-014");
		AddRecipientDetails.recipDetails(objReciDtls);
		AddRecipientDetails.recipBankDetails(objReciDtls);
		AddRecipientDetails.enterRecipientAddressDetailsInAllIndividualFields( objReciDtls);
		ErrorMessageData objErrDtls=TestDataReader.loadErrorMsg();
	...
	public static void tc015InvalidZip_VD_AddRecip_FI_FedWire() throws Exception{
		AddSenderDetails objSenderDtls=TestDataReader.loadSenderDetails("VD-RC-MGD-FW-000");
		AddSenderDetails.select_ClinetsRoutingNum(objSenderDtls);
		AddSenderDetails.addRecipBtnClick_SelectDivision_TransferType_PmtNetwk(objSenderDtls);
		AddRecipientDetails objReciDtls=TestDataReader.loadRecipientDetails_02("VD-RC-MGD-FW-015");
		AddRecipientDetails.recipDetails(objReciDtls);
		AddRecipientDetails.recipBankDetails(objReciDtls);
		AddRecipientDetails.enterRecipientAddressDetailsInAllIndividualFields( objReciDtls);
		ErrorMessageData objErrDtls=TestDataReader.loadErrorMsg();
	...
	public static void tc016InvalidEmail_VD_AddRecip_FI_FedWire() throws Exception {
		AddSenderDetails objSenderDtls=TestDataReader.loadSenderDetails("VD-RC-MGD-FW-000");
		AddSenderDetails.select_ClinetsRoutingNum(objSenderDtls);
		AddSenderDetails.addRecipBtnClick_SelectDivision_TransferType_PmtNetwk(objSenderDtls);
		AddRecipientDetails objReciDtls=TestDataReader.loadRecipientDetails_02("VD-RC-MGD-FW-016");
		AddRecipientDetails.recipDetails(objReciDtls);
		AddRecipientDetails.recipBankDetails(objReciDtls);
		AddRecipientDetails.enterRecipientAddressDetailsInAllIndividualFields( objReciDtls);
		ErrorMessageData objErrDtls=TestDataReader.loadErrorMsg();
	...
	public static void tc017InvalidPhone_VD_AddRecip_FI_FedWire()throws Exception {
		AddSenderDetails objSenderDtls=TestDataReader.loadSenderDetails("VD-RC-MGD-FW-000");
		AddSenderDetails.select_ClinetsRoutingNum(objSenderDtls);
		AddSenderDetails.addRecipBtnClick_SelectDivision_TransferType_PmtNetwk(objSenderDtls);
		AddRecipientDetails objReciDtls=TestDataReader.loadRecipientDetails_02("VD-RC-MGD-FW-017");
		AddRecipientDetails.recipDetails(objReciDtls);
		AddRecipientDetails.recipBankDetails(objReciDtls);
		AddRecipientDetails.enterRecipientAddressDetailsInAllIndividualFields( objReciDtls);
		ErrorMessageData objErrDtls=TestDataReader.loadErrorMsg();
	...
	public static void tc018EmptyRoutingNum_VD_AddRecip_FI_FedWire() throws Exception{
		AddSenderDetails objSenderDtls=TestDataReader.loadSenderDetails("VD-RC-MGD-FW-000");
		AddSenderDetails.select_ClinetsRoutingNum(objSenderDtls);
		AddSenderDetails.addRecipBtnClick_SelectDivision_TransferType_PmtNetwk(objSenderDtls);
		AddRecipientDetails objReciDtls=TestDataReader.loadRecipientDetails_02("VD-RC-MGD-FW-018");
		AddRecipientDetails.recipDetails(objReciDtls);
		AddRecipientDetails.recipBankDetails(objReciDtls);
		AddRecipientDetails.enterRecipientAddressDetailsInAllIndividualFields( objReciDtls);
		ErrorMessageData objErrDtls=TestDataReader.loadErrorMsg();
	...
	public static void tc019InvalidRoutingNum_VD_AddRecip_FI_FedWire() throws Exception{
		AddSenderDetails objSenderDtls=TestDataReader.loadSenderDetails("VD-RC-MGD-FW-000");
		AddSenderDetails.select_ClinetsRoutingNum(objSenderDtls);
		AddSenderDetails.addRecipBtnClick_SelectDivision_TransferType_PmtNetwk(objSenderDtls);
		AddRecipientDetails objReciDtls=TestDataReader.loadRecipientDetails_02("VD-RC-MGD-FW-019");
		AddRecipientDetails.recipDetails(objReciDtls);
		AddRecipientDetails.recipBankDetails(objReciDtls);
		AddRecipientDetails.enterRecipientAddressDetailsInAllIndividualFields( objReciDtls);
		ErrorMessageData objErrDtls=TestDataReader.loadErrorMsg();
	...
	public static void tc020EmptyAccountNum_VD_AddRecip_FI_FedWire() throws Exception{
		AddSenderDetails objSenderDtls=TestDataReader.loadSenderDetails("VD-RC-MGD-FW-000");
		AddSenderDetails.select_ClinetsRoutingNum(objSenderDtls);
		AddSenderDetails.addRecipBtnClick_SelectDivision_TransferType_PmtNetwk(objSenderDtls);
		AddRecipientDetails objReciDtls=TestDataReader.loadRecipientDetails_02("VD-RC-MGD-FW-020");
		AddRecipientDetails.recipDetails(objReciDtls);
		AddRecipientDetails.recipBankDetails(objReciDtls);
		AddRecipientDetails.enterRecipientAddressDetailsInAllIndividualFields( objReciDtls);
		ErrorMessageData objErrDtls=TestDataReader.loadErrorMsg();
	...
	public static void tc021InvalidAccountNum_VD_AddRecip_FI_FedWire() throws Exception{
		AddSenderDetails objSenderDtls=TestDataReader.loadSenderDetails("VD-RC-MGD-FW-000");
		AddSenderDetails.select_ClinetsRoutingNum(objSenderDtls);
		AddSenderDetails.addRecipBtnClick_SelectDivision_TransferType_PmtNetwk(objSenderDtls);
		AddRecipientDetails objReciDtls=TestDataReader.loadRecipientDetails_02("VD-RC-MGD-FW-021");
		AddRecipientDetails.recipDetails(objReciDtls);
		AddRecipientDetails.recipBankDetails(objReciDtls);
		AddRecipientDetails.enterRecipientAddressDetailsInAllIndividualFields( objReciDtls);
		ErrorMessageData objErrDtls=TestDataReader.loadErrorMsg();
